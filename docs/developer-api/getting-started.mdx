...
Use `https://api.sarufi.io/api/dev/v1` as the primary API base URL.
The `developers.sarufi.io` host points to the same API version and can be used as an equivalent alias.
